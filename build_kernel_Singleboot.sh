...
ROOTFS_PATH="$TOP_DIR/initramfs_Singleboot"

KERNEL_NAME="Homura-Kernel"
CONFIG_FILE="$KERNEL_PATH/arch/arm/configs/Homura_Singleboot_defconfig"

export LOCALVERSION="-$KERNEL_NAME"
export KBUILD_BUILD_VERSION="Single21a"
