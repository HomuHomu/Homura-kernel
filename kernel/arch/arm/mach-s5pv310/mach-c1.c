...
#else
REGULATOR_INIT(ldo13, "VCC_2.5V_LCD", 2500000, 2500000, 1,
		REGULATOR_CHANGE_STATUS, 1);
#endif
...
REGULATOR_INIT(ldo17, "CAM_AF_2.8V", 2800000, 2800000, 0,
		REGULATOR_CHANGE_STATUS, 1);
#endif
REGULATOR_INIT(ldo18, "TOUCH_LED_2.8V", 2500000, 2800000, 0,
		REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_VOLTAGE, 1);

REGULATOR_INIT(ldo21, "VDDQ_M1M2_1.1V", 1100000, 1100000, 1,
		REGULATOR_CHANGE_STATUS, 1);
