...
ROOTFS_PATH="$TOP_DIR/initramfs_cm7_sp"
export LOCALVERSION="-Homura-kernel"
export KBUILD_BUILD_VERSION="CyanogenMod1"
...
cp -f $KERNEL_PATH/arch/arm/configs/Homura_cm7sp_defconfig $KERNEL_PATH/.config
